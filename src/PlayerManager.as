package  {
	...
	public class PlayerManager {
		...
		public function checkAttackStatus():void {
			if (!attacking)
				return;
			if (playerIsFacing("right") && view.person.currentFrame != 7) {
				view.attackHitBox.x = 0;
				view.person.gotoAndStop("attackR");
				view.person.attackRight.play();
			}
			if (playerIsFacing("left") && view.person.currentFrame != 8) {
				view.attackHitBox.x = -200;
				view.person.gotoAndStop("attackL");
